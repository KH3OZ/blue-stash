  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        // Offset by the site header's height (h-16 = 4rem in site-header.tsx) so the
        // fixed sidebar starts below the sticky header instead of covering it.
        className={cn(
          "fixed top-16 z-10 hidden h-[calc(100svh-4rem)] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex",
